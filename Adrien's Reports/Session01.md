...
Having received the official vinyl game mat, we wanted to calculate the coefficient of adhesion between the wheels and the mat during this session. However, our scale was limited to loads of 2 kg, so we have to postpone this calculation to later. However, this allowed us to observe the very strong adhesion of the roller wheels on the vinyl and to manufacture the suspended bucket system that will be used later.
